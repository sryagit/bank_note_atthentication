...
def main():
    ...
    if st.button("Get Prediction"):
        ...
        st.markdown("<h5 style='color:red'> 0 <span style='color:white'> means </span> banknote is forged </h5>",  unsafe_allow_html=True)
        st.markdown("<h6 style='color:LawnGreen'> 1 <span  style='color:White'> means </span> banknote is genuine</h6>", unsafe_allow_html=True)
